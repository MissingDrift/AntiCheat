package me.missingdrift.anticheat.util.command;
...
public class CommandUtils {
    ...
    public static void registerCommand(me.missingdrift.anticheat.base.command.Command commandObject) {
        try {
    ...
    public static void unRegisterBukkitCommand(me.missingdrift.anticheat.base.command.Command commandObject) {
        try {
