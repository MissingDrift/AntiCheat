package me.missingdrift.anticheat.util.box;

import me.missingdrift.anticheat.base.user.objects.BlockData;
import me.missingdrift.anticheat.tinyprotocol.packet.types.BaseBlockPosition;
import me.missingdrift.anticheat.util.BlockUtil;
import me.missingdrift.anticheat.util.MathUtil;
import me.missingdrift.anticheat.util.block.CollideEntry;
...
public class BoundingBox {
    ...
    public BoundingBox a(BaseBlockPosition blockposition) {
    ...
    public BoundingBox expandWithBlock(BaseBlockPosition blockposition, BlockData iblockdata) {
