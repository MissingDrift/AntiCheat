...
import me.missingdrift.anticheat.tinyprotocol.packet.types.WrappedEnumMainHand;
...
public class WrappedInSettingsPacket extends NMSObject {
    ...
    private static final WrappedField fieldLocale;
    private static final WrappedField fieldView;
    private static final WrappedField fieldChatVisibility;
    private static final WrappedField fieldChatColors;
    //1.7.10 only
