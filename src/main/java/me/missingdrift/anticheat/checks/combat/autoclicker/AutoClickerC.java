package me.missingdrift.anticheat.checks.combat.autoclicker;
...
@CheckInformation(checkName = "AutoClicker", checkType = "C", lagBack = false, description = "Checks if the player is clicking consistently")
